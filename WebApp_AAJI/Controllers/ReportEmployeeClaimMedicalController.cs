...
{
    public class ReportEmployeeClaimMedicalController : Controller
    {
        ...
        //
        // GET: /ReportEmployeeClaimMedical/
        ...
        public async Task<ActionResult> loadDetail(DateTime startDate, DateTime endDate)
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                using (SqlDataAdapter da = new SqlDataAdapter())
                {
                    ...
                    cmd.CommandText = "sp_reportEmployeeClaimMedical";
            ...
            return PartialView("ReportEmployeeClaimMedical_PartialPage");
        }
	}
}