...
{
    public class ReportEmployeeLoanController : Controller
    {
        ...
        public async Task<ActionResult> loadDetail(DateTime startDate, DateTime endDate)
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                using (SqlDataAdapter da = new SqlDataAdapter())
                {
                    ...
                    cmd.CommandText = "sp_reportEmployeeLoan";
            ...
            return PartialView("ReportEmployeeLoan_PartialPage");
        }
	}
}