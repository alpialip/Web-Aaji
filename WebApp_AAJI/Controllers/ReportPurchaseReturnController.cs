...
namespace WebApp_AAJI.fonts
{
    public class ReportPurchaseReturnController : Controller
    {
        public MyDataAccess db = new MyDataAccess();
        public ConnectionController conDB = new ConnectionController();
        //
        // GET: /ReportPurchaseReturn/
        ...
        public async Task<ActionResult> loadDetail(DateTime startDate, DateTime endDate)
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                using (SqlDataAdapter da = new SqlDataAdapter())
                {
                    ...
                    cmd.CommandText = "sp_reportPurchaseReturn";
            ...
            return PartialView("ReportPurchaseReturn_PartialPage");
        }
	}
}